      ...
      >
        ...
        <div class="nav-buttons flex flex-row items-center">
          ...
          <RoughNotation class="mr-4" :is-show="notationconnect" type="circle">
            <div
              class="cursor-pointer"
              @mouseenter="notationconnect = true"
              @mouseleave="notationconnect = false"
          ...
          <RoughNotation :is-show="notationlogout" type="circle">
            <div
              class="cursor-pointer"
              @mouseenter="notationlogout = true"
              @mouseleave="notationlogout = false"
              @click="logout"
            >
              Logout
            </div>
      ...
      <div class="options flex py-3 w-full">
        <div class="option mx-3 bg-pastel_red/30">
          <div class="image pt-3 pb-5">
            <img
              src="../assets/rainbow-woman.png"
              alt=""
              class="mx-auto pl-5 w-100 h-100"
            />
          </div>
        ...
        <div class="option bg-pastel_yellow/30">
          <div class="image pt-3 pb-5">
            <img
              ...
              alt=""
              class="mx-auto px-5 w-100 h-100"
            />
          </div>
          <div class="flex justify-evenly">
            <div @click="trackFlow" class="btn-border">Track</div>
            <div
        ...
        <div class="option mx-3 bg-pastel_blue/30">
          <div class="image pt-3 pb-5">
            <img
              ...
              alt=""
              class="mx-auto pl-6 pt-2 w-100 h-100"
            />
          </div>
          <div class="flex justify-evenly">
            <div class="btn-border" @click="openHashnode">Read</div>
          </div>
        </div>
      </div>
    </div>
